...
void* tl_blink(void* l) {    
	...
	switch(led) {
		case LED_BLU:
			printf("tl_blink blu end\n");
			btn_stat.blu = BTN_OFF;
			break;
		case LED_YLW:
			printf("tl_blink ylw end\n");
			btn_stat.ylw = BTN_OFF;
			break;
		case LED_GRN:
			printf("tl_blink grn end\n");
			btn_stat.grn = BTN_OFF;
			break;
		case LED_RED:
			printf("tl_blink red end\n");
			btn_stat.red = BTN_OFF;
			break;
	}
	return (void*)0;
